...
- (void)layoutSubviews
{
    ...
    CGFloat height=[self.placehoder sizeWithFont:self.placehoderLabel.font constrainedToSize:CGSizeMake(self.frame.size.width, 20000)].height;
    
    self.placehoderLabel.frame=CGRectMake(x, y, width, height);
    //    self.placehoderLabel.frame.origin.y = 8;
    ...
    //    self.placehoderLabel.height = place
}
